        ...
        {marathons.map((marathon) => (
          <div key={marathon._id} className="rounded-xl shadow-inner  shadow-blue-800/20 hover:shadow-rose-500/20 transform transition-transform duration-300 hover:scale-105">
            <div className="lg:h-56 w-full p-3">
              <img className="w-full h-full rounded-lg" src={marathon.marathon_image} alt="" />
            </div>

            <div className="p-6 pt-0">
              <h4 className="font-semibold text-xl text-center">{marathon.marathon_title}</h4>
              <p className="font-light text-sm text-center">
                Location:{" "}
                <span className="text-base font-medium">{marathon.location}</span>
              </p>
